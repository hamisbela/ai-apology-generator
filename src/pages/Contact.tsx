          ...
          <div className="space-y-8">
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">contact@aiapologygenerator.com</p>
              </Card>
            </div>
            ...
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">@AIApologyGen</p>
              </Card>
            </div>
          ...
          <div className="gradient-border">
            <Card className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-lg bg-gradient-to-r from-pink-500 to-red-600 hover:from-pink-600 hover:to-red-700"
                >
